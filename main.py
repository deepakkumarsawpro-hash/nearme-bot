...
def send_response(to, text):
    ...
    if "hi" in text or "hello" in text:
        ...
        payload = {
            ...
            "text": {"body": "Great! Apni location share karne ke liye:\n1. Chat mein niche diye gaye 'Pin/Attach' icon par click karein.\n2. 'Location' select karein.\n3. 'Send current location' par click karein."}
        }
        ...
        payload = {
            ...
            "interactive": {
                ...
                "body": {"text": "Location mil gayi! Apni Category chunein:"},
                "action": {
                    "button": "Categories Dekhein",
                    "sections": [
                        {"title": "1. Construction", "rows": [
                            {"id": "mason", "title": "Mason (मिस्त्री)"}, {"id": "architect", "title": "Architect"}, {"id": "plumber", "title": "Plumber"}]},
                        {"title": "2. Automotive", "rows": [
                            {"id": "mechanic", "title": "Mechanic"}, {"id": "transport", "title": "Transport"}]},
                        {"title": "3. Food & Daily", "rows": [
                            {"id": "food", "title": "Restaurant/Dhaba"}, {"id": "grocery", "title": "Grocery"}]}
                    ]
                }
            }
        }
