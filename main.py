        ...
        try:
            if 'messages' in data['entry'][0]['changes'][0]['value']:
                ...
                if "hi" in user_msg or "hello" in user_msg:
                    ...
                    reply = "Main ek bot hoon, main bilkul mast hoon! Aap bataiye?"
                elif "bye" in user_msg:
                    reply = "Alvida! Phir milenge."
                else:
                    reply = f"Mujhe samajh nahi aaya. Aapne likha: '{text}'. Kya aap kuch aur puchna chahte hain?"
                # --- Custom Reply Logic End ---
