    ...
    try:
        ...
        if 'interactive' in msg:
            ...
            if sel_id == "buyer":
                ...
                send_menu(sender, "Categories", "भाग 1:", [{"id": "c1", "title": "Kirana"}, {"id": "c2", "title": "Hotel"}, {"id": "c3", "title": "Repair"}])
        elif 'location' in msg:
            send_menu(sender, "Main Menu", "आप कौन हैं?", [{"id": "buyer", "title": "Buyer"}, {"id": "seller", "title": "Seller"}])
        else:
