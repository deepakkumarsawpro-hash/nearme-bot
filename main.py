            ...
            for change in entry.get('changes', []):
                ...
                if 'messages' in value:
                    for message in value['messages']:
                        ...
                        # Agar user location bhejta hai, toh uska logic yahan aayega
...
def send_response(to, text):
    ...
    if "hi" in text or "hello" in text:
        ...
        # Instruction for the user to use the Pin Icon
        payload = {
        ...
        payload = {"messaging_product": "whatsapp", "to": to, "type": "text", "text": {"body": "Location mil gayi! Hum aapke aas-paas ki services dhoond rahe hain..."}}
